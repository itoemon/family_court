    ...
    return (
      <main className="min-h-screen bg-stone-50 flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-sm text-center">
          ...
          <Link
            href="/auth/login"
            className="inline-block mt-6 text-rose-400 font-semibold text-sm hover:text-rose-300"
          >
            ログインページへ →
          </Link>
        </div>
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-stone-100 p-7">
          ...
          <p className="text-center text-sm text-stone-500 mt-4">
            すでにアカウントをお持ちの方は{" "}
            <Link href="/auth/login" className="text-rose-400 font-semibold hover:text-rose-300">
              ログイン
            </Link>
          </p>
        </div>
